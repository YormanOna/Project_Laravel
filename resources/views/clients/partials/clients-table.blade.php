        ...
        @forelse($clients as $client)
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                    <span
                        class="px-3 py-1 text-xs font-medium rounded-full inline-flex items-center {{ $client->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <div class="flex space-x-2">
                        ...
                        <form method="POST" action="{{ route('crearTokenAccesoCliente') }}">
                            @csrf
                            <input type="hidden" name="cliente" value="{{ $client->id }}">
                            <input type="hidden" name="nombre" value="Token Cliente #{{ $client->id }}">
                            <button type="submit" ...>
